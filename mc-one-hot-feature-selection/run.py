...
flags.DEFINE_integer('max_iter', 500, 'Number of iterations of the algorithm.')
flags.DEFINE_float('tol', 1e-7, 'Tolerance threshold of convergence.')
flags.DEFINE_integer('runs', 1, 'Number of runs.')
flags.DEFINE_integer('inner_iter', 50, 'Number of iterations before updating the variables weights.')
